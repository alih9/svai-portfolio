...
export const metadata: Metadata = {
  title: 'Reset Password | SparkVerse AI',
};
      ...
      <div className="container">
        ...
        >
          <div className="lg:mb-12.5 md:mb-10 mb-7.5 text-center">
            <h1 className="lg:text-6xl md:text-5.5xl text-4xl">Reset password </h1>
            <p className="mb-2.5">Enter your registered email to reset your password </p>
          </div>
