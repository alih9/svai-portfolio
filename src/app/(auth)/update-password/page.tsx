...
export const metadata: Metadata = {
    title: 'Update Password | Spark Verse AI',
};
            ...
            <div className="container">
                ...
                >
                    <div className="lg:mb-12.5 md:mb-10 mb-7.5 text-center">
                        <h1 className="lg:text-6xl md:text-5.5xl text-4xl">Update password </h1>
                        <p className="mb-2.5">
                            Please enter your new password. Make sure you are not using your current
                            password.{' '}
                        </p>
                    </div>
