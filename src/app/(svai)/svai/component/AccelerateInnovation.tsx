...
const AccelerateInnovation = () => {
  return (
    <>
      <section>
        <div
          className="relative lg:py-25 md:py-22.5 py-17.5 flex items-center justify-center overflow-hidden"
        >
          <video
          ...
          />
          <div
            className="relative z-10 bg-body-bg py-15 px-5 lg:w-3/5 md:w-4/5 w-9/10 rounded-2xl text-center"
            data-aos="fade-up"
            data-aos-delay={200}
