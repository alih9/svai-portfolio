...
type ExcalidrawImperativeAPI = Parameters<
  Required<ExcalidrawProps>['excalidrawAPI']
>[0];
export type AppState = Parameters<Required<ExcalidrawProps>['onChange']>[1];
export type BinaryFiles = Parameters<Required<ExcalidrawProps>['onChange']>[2];
export type ExcalidrawInitialElements = Parameters<
  Required<ExcalidrawProps>['onChange']
>[0];
